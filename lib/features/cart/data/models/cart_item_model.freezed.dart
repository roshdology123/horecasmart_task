...
abstract class $CartItemModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@ProductConverter() Product product, int quantity, double totalPrice});
...
class _$CartItemModelImpl implements _CartItemModel {
  _$CartItemModelImpl(
      {@ProductConverter() required this.product,
  ...
  @override
  String toString() {
    return 'CartItemModel(product: $product, quantity: $quantity, totalPrice: $totalPrice)';
  }
